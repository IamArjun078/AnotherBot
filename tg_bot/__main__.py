...
def send_start(bot, update):
    ...
    text = "Hey there! My name is tg_bot Aya - I'm here to help you manage your groups!\n\
Click Help button to find out more about how to use me to my full potential.\n\n"

    text += "Join [tg_bot Aya Group](https://t.me/tg_botAyaGroup) ( @tg_botAyaGroup ) if you need any support or help\n\n\
Follow [tg_bot Aya](https://t.me/tg_botAya) ( @tg_botAya ) if you want to keep up with the news, updates and bot downtime!\n\n\
Made with love by @peaktogoo\n\nWant to add me to your group? [Click here!](t.me/tg_botAyaBot?startgroup=true)"

    keyboard = [[InlineKeyboardButton(text="📢 Support Group", url="https://t.me/tg_botAyaGroup")]]
...
def control_panel(bot, update):
    ...
    if query:
        ...
        M_match = "tg_bot Aya is best bot" #LMAO, don't uncomment
